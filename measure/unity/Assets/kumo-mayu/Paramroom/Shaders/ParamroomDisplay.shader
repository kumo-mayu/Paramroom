// Paramroom primitive decoder - display quad. Shows the display canvas region of the decoder atlas
// (C = _Canvas: x C..2C, y 0..C, values 0..255; see ParamroomDecoder.shader), with the quad reshaped to the sent
// aspect ratio.
Shader "Paramroom/Display"
{
    Properties
    {
